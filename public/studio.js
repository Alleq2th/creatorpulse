...
function camView(st){
  ...
  return `<div class="cs-fs">
    ...
    <div class="cs-cam-stage" id="cs-cam-stage">
      <video id="cs-cam-live" playsinline muted autoplay style="transform:${st.mirror&&st.facing==='user'?'scaleX(-1)':''};transform-origin:center center"></video>
