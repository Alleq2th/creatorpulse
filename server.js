...
// ── ROUTE: GET NEWS (strict filtering) ──────────────────────────────────────
app.get("/api/news", async (req, res) => {
  ...
  try {
      ...
      if (data.articles && data.articles.length > 0) {
        ...
        const scored = data.articles
          .map(a => {
            ...
            // Article must have at least one query word in title OR at least 2 in description
    ...
    // Fallback RSS with strict filtering
